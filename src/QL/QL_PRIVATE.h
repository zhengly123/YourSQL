...
#ifndef YOURSQL_QL_PRIVATE_H
#define YOURSQL_QL_PRIVATE_H

#include "../errorhandle.h"
const int QL_RELNOTEXIST = YOURSQL_QL_ERROR_START;
...
const int QL_FOREIGN_KEY_NOT_FOUND = QL_PRIMARY_DUPLICATE + 1;
const int QL_AGAINST_FOREIGN_KEY_CONSTRAINT = QL_FOREIGN_KEY_NOT_FOUND + 1;

#endif //YOURSQL_QL_PRIVATE_H
